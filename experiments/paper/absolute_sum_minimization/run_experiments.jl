...
include("../../../src/NAML.jl")
include("../util.jl")          # Shared util: generate_random_padic, wrap_loss_with_counting, etc.
include("../experiment_utils.jl")  # Shared: CLI parsing, optimizer factory, threaded runner
include("util.jl")             # Local: generate_random_absolute_sum_problem, etc.
