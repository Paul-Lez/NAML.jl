...
# Test at x=0
x_param1 = ValuationPolydisc([K(0)], [0])
loss_sys1 = loss_system.eval([x_param1])[1]
println("   At x=0: loss = ", loss_sys1, " (residual = -4, loss = 16)")

# Test at x=2
x_param2 = ValuationPolydisc([K(2)], [0])
loss_sys2 = loss_system.eval([x_param2])[1]
println("   At x=2: loss = ", loss_sys2, " (should be 0)")

# Test at x=1
x_param3 = ValuationPolydisc([K(1)], [0])
loss_sys3 = loss_system.eval([x_param3])[1]
println("   At x=1: loss = ", loss_sys3, " (residual = -2, loss = 4)")
